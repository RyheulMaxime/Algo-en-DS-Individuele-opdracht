...
first create an instance folder in the root folder of the repository, then place the local config.py file in that folder (mail me if you need the config.py file to connect to the server, for security reasons this was not included in the repository). <br />
If the configs are not provided in the environment, what happens with Render, then flask will look at the configs in that folder.
